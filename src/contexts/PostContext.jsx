...
function PostProvider({children}){
    ...
    return <PostContext.Provider value={{posts: searchedPosts,onClearPosts: handleClearPosts,searchQuery,setSearchQuery,onAddPost: handleAddPost}}>{children}</PostContext.Provider>
}
